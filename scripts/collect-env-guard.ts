...
function main() {
  ...
  const good = runGuard({ NODE_ENV: 'production', OPENAI_API_KEY: process.env.OPENAI_API_KEY || 'sk-dummy', DATABASE_URL: 'postgresql://umca:StrongPass123!@localhost:5433/umca', MINIO_ACCESS_KEY: 'strongaccesskey123456', MINIO_SECRET_KEY: 'strongsecretkey1234567890', LANGFUSE_PUBLIC_KEY: 'pk', LANGFUSE_SECRET_KEY: 'sk' });
